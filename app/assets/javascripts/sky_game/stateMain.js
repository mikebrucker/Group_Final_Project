const StateMain={    
    ...
    preload:function(){
         ...
         game.load.image("platform", "sky_assets/images/main/platform.png")
         game.load.spritesheet("soundButtons", "sky_assets/images/ui/soundButtons.png", 44, 44, 4);
         game.load.spritesheet("traveler", "sky_assets/images/main/traveler.png",64,64,33);
         game.load.spritesheet("coins", "sky_assets/images/main/coins_all.png",15.875,16,8);
         game.load.spritesheet("wasp", "sky_assets/images/main/wasp.png",96,96,11);
         game.load.audio("backgroundMusic", "sky_assets/sounds/background.mp3");
         game.load.audio("jump", "sky_assets/sounds/jump.mp3");
         game.load.audio("pick", "sky_assets/sounds/pickup.mp3");
         game.load.audio("waspSound", "sky_assets/sounds/wasp.mp3");
