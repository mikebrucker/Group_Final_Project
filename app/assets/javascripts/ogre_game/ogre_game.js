...
gameScene.preload = function() {
  // load images
  this.load.image('background', 'ogre_assets/images/background.png');
  this.load.image('player', 'ogre_assets/images/player.png');
  this.load.image('skeleton', 'ogre_assets/images/skeleton.png');
  this.load.image('treasure', 'ogre_assets/images/treasure.png');
  this.load.audio('backgroundMusic', 'ogre_assets/sounds/horror.mp3');
  this.load.audio('fail', 'ogre_assets/sounds/game_fail.mp3');
  this.load.audio('powerUp', 'ogre_assets/sounds/game_power_up.mp3');
  this.load.audio('powerUp2', 'ogre_assets/sounds/game_power_up_2.mp3');
  this.load.audio('timeUp', 'ogre_assets/sounds/siren.mp3');
};
